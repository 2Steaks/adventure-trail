  ...
  public: {
    Tables: {
      ...
      game_states: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_states_adventure_id_fkey"
          ...
          {
            foreignKeyName: "game_states_current_quest_id_fkey"
            columns: ["current_quest_id"]
            isOneToOne: false
      ...
      quests: {
        ...
        Relationships: [
          {
            foreignKeyName: "quests_adventure_id_fkey"
            columns: ["adventure_id"]
            isOneToOne: false
            referencedRelation: "adventures"
            referencedColumns: ["id"]
